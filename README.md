...
# Requires the value passed to `--data` to be a path to a directory that is similar in structure to https://github.com/xeeshan85/imc-prosperity-4-backtester/tree/master/prosperity4bt/resources
...
This backtester is based on [Jasper van Merle's Prosperity 3 Backtester](https://github.com/jmerle/imc-prosperity-3-backtester), adapted for Prosperity 4.

- Original author: [Jasper van Merle](https://github.com/jmerle)
